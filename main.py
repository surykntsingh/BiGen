...
def parse_agrs():
    ...
    parser.add_argument('--bank_path', type=str, default='/lustre/nvwulf/projects/PrasannaGroup-nvwulf/surya/datasets/TCGA_processed/conch/knowledge_bank/memory_short.pt', help='the path to the directory containing the knowledge bank')
