...
def parse_agrs():
    ...
    parser.add_argument('--image_dir_plip', type=str, default='/lustre/nvwulf/projects/PrasannaGroup-nvwulf/surya/datasets/TCGA_processed/plip/pt_files', help='the path to the directory containing the encoded wsi patches using PLIP.')
    ...
    parser.add_argument('--bank_path', type=str, default='/lustre/nvwulf/projects/PrasannaGroup-nvwulf/surya/datasets/TCGA_processed/plip/knowledge_bank/memory_short.pt', help='the path to the directory containing the knowledge bank')
    ...
    parser.add_argument('--record_dir', type=str, default='records/BRCA/', help='the patch to save the results of experiments')
